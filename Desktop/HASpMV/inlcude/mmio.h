...
int mm_read_mtx_crd_size(FILE *f, int *M, int *N, int64_t *nz);
int mm_read_mtx_array_size(FILE *f, int *M, int *N);

int mm_write_banner(FILE *f, MM_typecode matcode);
int mm_write_mtx_crd_size(FILE *f, int M, int N, int64_t nz);
...
int mm_write_mtx_crd(char fname[], int M, int N, int64_t nz, int I[], int J[],
                     double val[], MM_typecode matcode);
int mm_read_mtx_crd_data(FILE *f, int M, int N, int64_t nz, int I[], int J[],
                         double val[], MM_typecode matcode);
int mm_read_mtx_crd_entry(FILE *f, int *I, int *J, double *real, double *img,
                          MM_typecode matcode);

int mm_read_unsymmetric_sparse(const char *fname, int *M_, int *N_, int64_t *nz_,
...
int mm_read_mtx_crd(char *fname, int *M, int *N, int64_t *nz, int **I, int **J,
                    double **val, MM_typecode *matcode)
{
    int ret_code;
    FILE *f;
